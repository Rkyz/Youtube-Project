...
const MaxSidebar = ({openToggle}) => {
    ...
    return (
        <div onMouseEnter={onMouseScrollOpen} onMouseLeave={onMouseScrollOpen} className={`bg-transparent z-50  fixed  text-white max-h-screen overflow-x-scroll max-3nm:w-0  max-1nm:max-w-[80px] 1nm:max-w-[260px] ${scroll ? '1nm:scroll-custom  ':'hidden-scroll'} ${openToggle ? '1nm:max-w-[80px]':''}`}>
