...
const Suggestion = ({openToggle}) => {
  return (
    <div className={`bg-Black max-h-[80px] z-40 h-full w-full fixed flex items-center max-3nm:px-[30px] 1nm:pr-[10px] max-1nm:pl-[100px] max-1nm:pr-[40px] ${openToggle ? 'pl-[100px]':'pl-[260px]'} `}>
